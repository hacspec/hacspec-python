...
# Define prime field
d25519 : felem_t = felem(nat(37095705934669439343138083508754565189542113879843219016388785533085940283555))
q25519 : felem_t = felem(nat((1 << 252) + 27742317777372353535851937790883648493))
...
def point_double(p:extended_point_t) -> extended_point_t:
  ...
  a = fmul(x1,x1)
  b = fmul(y1,y1)
  c = fmul(to_felem(nat(2)),fmul(z1,z1))
  h = fadd(a,b)
...
_g_x : felem_t = felem(nat(15112221349535400772501151409588531511454012693041857206046113283949847762202))
_g_y : felem_t = felem(nat(46316835694926478169428394003475163141307993866256225615783033603165251855960))
