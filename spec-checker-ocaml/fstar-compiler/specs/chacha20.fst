...
let subblock_t: Type0 = (x: vlarray_t uint8_t {(array_length x) <=. blocksize})
let constants_t: Type0 = array_t uint32_t 4
let line
  (a: range_t 0 16) (b: range_t 0 16) (d: range_t 0 16) (s: range_t 1 32) (m: array_t uint32_t 16)
  : array_t uint32_t 16 =
  ...
  m
let quarter_round
  (a: range_t 0 16) (b: range_t 0 16) (c: range_t 0 16) (d: range_t 0 16) (m: array_t uint32_t 16)
  : array_t uint32_t 16 =
  ...
  m
let double_round (m: array_t uint32_t 16) : array_t uint32_t 16 =
  ...
  m
let constants: array_t uint32_t 4 =
  array (array_createL [uint32 1634760805; uint32 857760878; uint32 2036477234; uint32 1797285236])
let chacha20_init (k: array_t uint8_t 32) (counter: uint32_t) (nonce: array_t uint8_t 12)
  : array_t uint32_t 16 =
  ...
  st
let chacha20_core (st: array_t uint32_t 16) : array_t uint32_t 16 =
  ...
  in
  working_state
let chacha20 (k: array_t uint8_t 32) (counter: uint32_t) (nonce: array_t uint8_t 12)
  : array_t uint32_t 16 = chacha20_core (chacha20_init k counter nonce)
let chacha20_block (k: array_t uint8_t 32) (counter: uint32_t) (nonce: array_t uint8_t 12)
  : array_t uint8_t 64 =
  let st = chacha20 k counter nonce in
  let block = bytes_from_uint32s_le st in
  block
let xor_block (block: array_t uint8_t 64) (keyblock: array_t uint8_t 64) : array_t uint8_t 64 =
  ...
  in
  out
let chacha20_counter_mode
  (key: array_t uint8_t 32) (counter: uint32_t) (nonce: array_t uint8_t 12) (msg: vlarray_t uint8_t)
  : vlarray_t uint8_t =
...
let chacha20_encrypt
  (key: array_t uint8_t 32) (counter: uint32_t) (nonce: array_t uint8_t 12) (msg: vlarray_t uint8_t)
  : vlarray_t uint8_t = chacha20_counter_mode key counter nonce msg
let chacha20_decrypt
  (key: array_t uint8_t 32) (counter: uint32_t) (nonce: array_t uint8_t 12) (msg: vlarray_t uint8_t)
  : vlarray_t uint8_t = chacha20_counter_mode key counter nonce msg
